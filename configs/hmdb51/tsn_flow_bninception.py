...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/hmdb51/hmdb51_rgb_train_split_1.txt',
    ...
    val=dict(
        type=dataset_type,
        ann_file='data/hmdb51/hmdb51_rgb_val_split_1.txt',
        img_prefix=data_root,
        img_norm_cfg=img_norm_cfg,
        num_segments=3,
        new_length=5,
...
log_level = 'INFO'
work_dir = './work_dirs/tsn_2d_flow_bninception_seg_3_f1s1_b32_g8_lr_0.005_hmdb51_split1'
load_from = None
resume_from = None
